...
type FakeFinder struct {
	FindStub        func(apiv1.VMCID) (vm.VM, bool, error)
...
func (fake *FakeFinder) Find(arg1 apiv1.VMCID) (vm.VM, bool, error) {
	fake.findMutex.Lock()
...
func (fake *FakeFinder) FindArgsForCall(i int) apiv1.VMCID {
	fake.findMutex.RLock()
	defer fake.findMutex.RUnlock()
	return fake.findArgsForCall[i].arg1
}

func (fake *FakeFinder) FindReturns(result1 vm.VM, result2 bool, result3 error) {
	fake.FindStub = nil
...
var _ vm.Finder = new(FakeFinder)
